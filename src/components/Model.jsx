    ...
    return (
        <div className='fixed inset-0 z-50 flex justify-center items-center w-full h-full overflow-hidden bg-black/40 backdrop-blur-sm'>
            <div className='relative p-4 w-full max-w-2xl max-h-[90vh]'>
                {/* Model header */}
                <div className='relative w-full bg-white rounded-xl shadow-2xl border border-gray-100'>
                    {/* Model content */}
                    <div className='flex items-center justify-between p-5 md:p-6 border-b border-gray-100 rounded-t-xl'>
                        ...
                        onClick={onClose}
                        type='button'
                        className='text-gray-500 bg-gray-50 hover:bg-gray-100 hover:text-red-900 rounded-lg text-sm w-9 h-9 flex items-center transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>
